...
// Define plans directly in the component (client-side safe)
const SUBSCRIPTION_PLANS = {
  ...
  clil_only: {
    ...
    price: 600, // $6.00 in cents
    priceId: 'price_1RrIE21Bs1c9VoEo1ada7Gt3',
    features: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 relative hover:shadow-xl transition-shadow">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">ESL Only</h3>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 relative hover:shadow-xl transition-shadow">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">CLIL Only</h3>
              <p className="text-gray-600 mb-6">Science learning in English for teenagers and young adults</p>
              
              <div className="mb-6">
                <span className="text-4xl font-bold text-gray-900">
                  {formatPrice(SUBSCRIPTION_PLANS.clil_only.price)}
                </span>
                <span className="text-gray-600">/month</span>
              </div>

              <ul className="text-left space-y-3 mb-8">
                {SUBSCRIPTION_PLANS.clil_only.features.map((feature, index) => (
                  <li key={index} className="flex items-start">
                    <svg className="h-5 w-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
              ...
              <button
                onClick={() => handlePlanSelection('clil_only')}
                disabled={processingCheckout}
              ...
              >
                {selectedPlan === 'clil_only' && processingCheckout ? (
                  <span className="flex items-center justify-center">
                    <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                      <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                      <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 relative hover:shadow-xl transition-shadow">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">CLIL Plus</h3>
          ...
          <div className="bg-white rounded-2xl shadow-xl border-2 border-green-300 p-8 relative hover:shadow-2xl transition-shadow">
            {/* Popular Badge */}
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Complete Learning Plan</h3>
              <p className="text-gray-600 mb-6">Everything included - choose your language support level</p>
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-600">ESL focuses on English through current news (adults), while CLIL teaches science subjects in English (teenagers).</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Can I switch between difficulty levels?</h3>
              <p className="text-gray-600">Yes! You can change between beginner and intermediate levels once per week to match your learning progress.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">What languages are supported?</h3>
              <p className="text-gray-600">CLIL Plus includes vocabulary support in Czech, German, French, Spanish, and Polish, with more languages coming soon.</p>
            </div>
          </div>
        </div>
