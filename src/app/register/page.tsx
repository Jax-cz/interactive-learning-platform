...
export default function RegisterPage() {
 ...
 const handleGoogleSignUp = async () => {
  ...
  <Link
    href="/login"              // ✅ CHANGE: "/" to "/login"
    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
  >
    Continue to Login         // ✅ CHANGE: "Back to Homepage" to "Continue to Login"
  </Link>
</div>
            </div>
          </div>
          ...
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
            ...
            <div className="border-t pt-6">
              <div className="flex items-center mb-3">
                <span className="text-sm font-medium text-gray-700">Have a Trial Code?</span>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Enter your Trial access code here"
